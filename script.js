...
const DATA = {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            price: 499,
            time:  40,
            image: "image/Lifting_eyelash.jpg",
          },
          {
            name:  "ลิฟติ้งขนคิ้ว",
            ...
            price: 399,
            time:  30,
            image: "image/Lifting_Eyebrown.jpg",
          },
          {
            name:  "ลิฟติ้งครบเซต",
          ...
          },
          {
            ...
            price: 999,
            time:  60,
            image: "image/Lifting_eyelash2.jpg",
          },
        ],
      },
      {
        ...
        items: [
          {
            name:  "นวดบำรุงผมและหนังศีรษะ + กัวซาหนังศีรษะ (แห้ง)",
            desc:  "",
            price: 199,
            time:  20,
            image: "image/HairGuasha.jpg",
          },
          {
  ...
  promotions: [
    {
      badge: "⭐ ครบเซตสุดคุ้ม",
      name:  "คอร์สครบเซต หน้า+ผิว VVIP",
      desc:  "นวดหน้าผลัดเซลล์ผิว 8 ขั้นตอน + นวดหน้ากัวซายกกระชับ + มาล์กเติมความชุ่มชื่น + อบสมุนไพร + ขัดผิวระเบิดขี้ไคล + มาส์กวิตามินน้ำนม + นวดน้ำมันเติมความชุ่มชื่น",
      price: 2990,
      oldPrice: 3386,
      image: "image/Guasha2.jpg",
    },
    {
      badge: "🤩 แนะนำ",
      name:  "คอร์สครบเซต หน้า+ผิว VIP",
      desc:  "นวดหน้าผลัดเซลล์ผิว 8 ขั้นตอน + นวดหน้ากัวซายกกระชับ + มาล์กเติมความชุ่มชื่น + อบสมุนไพร + ขัดผิวระเบิดขี้ไคล + มาส์กวิตามินน้ำนม",
      price: 2590,
      oldPrice: 2696,
      image: "image/Facial2.jpg",
    },
    {
      badge: "👍 ต้องลอง",
      name:  "นวดหน้าครบชุดVVIP",
      desc:  "นวดหน้าผลัดเซลล์ผิว + มาส์กหน้าสูตรบำรุงผิวมอบความชุ่มชื่นแบบล้ำลึก ลดริ้วรอย ผิวกระจ่างใส + อบสมุนไพร + ขัดผิวระเบิดขี้ไคล + มาส์กวิตามินน้ำนมนวดยกกระชับเดรนน้ำเหลือง",
      price: 1890,
      oldPrice: 2097,
      image: "image/Spa3.jpg",
    },
    {
      badge: "🔥 คุ้มค่า",
      name:  "สปาผิวเซ็ต B บำรุงผัวครบชุด",
      desc:  "อบสมุนไพร + ขัดผิวระเบิดขี้ไคล + นวดน้ำมันบำรุงผิว",
      price: 1750,
      image: "image/Spa4.jpg",
    },
    {
      badge: "🔥 ราคาดี",
      name:  "สปาผิวเซ็ต A ขัดผิว ระเบิดขี้ไคล",
      desc:  "อบสมุนไพร + ขัดผิวระเบิดขี้ไคล + มาส์กวิตามินน้ำนม",
      price: 1299,
      oldPrice: 1470,
      image: "image/Spa2.jpg",
    },
