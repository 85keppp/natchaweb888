...
const DATA = {
  ...
  services: {
    ...
    signature: [
      {
        name:  "เซต VVIP นวดหน้าครบชุด",
        cat:   "นวดหน้า",
        desc:  "นวดหน้าครบชุด + นวดหน้ายกกระชับ+ นวดหน้ากัวซาและมาส์กหน้าสูตรบำรุงผิวมอบความชุ่มชื่นแบบล้ำลึก ผิวฉ่ำโกลด์ อิ่มน้ำ + เน้นนวดยกกระชับเดรนน้ำเหลือง",
        price: 1299,
        time:  75,
